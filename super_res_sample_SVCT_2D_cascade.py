...
from dataloader_scripts.dataset_SVCT_2D import SVCT_Test
...
weight_avg = [0.5, 0.45, 0.40, 0.35, 0.30]
...
def main():
    ...
    # args.num_cascade = 3
    # save_path = './test_results_SVCT_2D_t200_path20_nonavg_cascade3/'
    ...
    # args.average_inv = None
    # args.num_cascade = 3
    # save_path = './test_results_SVCT_2D_t250_path20_nonavg_cascade3/'
    ...
    # args.average_inv = None
    # args.num_cascade = 3
    # save_path = './test_results_SVCT_2D_t300_path20_nonavg_cascade3/'
    ...
    # args.average_inv = None
    # args.num_cascade = 1
    # save_path = './test_results_SVCT_2D_t940_path20_nonavg_cascade1/'
    ...
    # args.average_inv = None
    # args.num_cascade = 1
    # save_path = './test_results_SVCT_2D_t700_path6_nonavg_cascade1_random111/'
    ...
    args.average_inv = None
    args.num_cascade = 1
    save_path = './test_results_SVCT_2D_t700_path9_nonavg_cascade1_random222/'
    ...
    #         # t_start_th = th.tensor([int(t_start_th.detach() * 0.8)])
...
def create_argparser():
    defaults = dict(
        ...
        use_ddim=True,
        base_samples="",
        # model_path="./model_SVCT_2D/model240000.pt",
        model_path="./model_SVCT_2D/model200000.pt",
    )
