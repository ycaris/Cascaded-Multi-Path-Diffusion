...
def main():
    ...
    args.average_inv = 2
    save_path = './test_results_SVCT_2D_tstart200_tend180_path20_avginv2/'

    # args.large_size = 256
    # args.t_start = 400
    # args.num_path = 20
    # args.use_average = True
    # save_path = './test_results_SVCT_2D_t400_path20_avg/'

    # args.large_size = 256
    # args.t_start = 600
    # args.num_path = 20
    # args.use_average = True
    # save_path = './test_results_SVCT_2D_t600_path20_avg/'

    # args.large_size = 256
    # args.t_start = 200
    # args.num_path = 20
    # args.use_average = False
    # save_path = './test_results_SVCT_2D_t200_path20_nonavg/'

    # args.large_size = 256
    # args.t_start = 200
    # args.num_path = 1
    # args.use_average = False
    # save_path = './test_results_SVCT_2D_t200_path1_nonavg/'

    # args.large_size = 256
    # args.t_start = 940
    # args.num_path = 20
    # args.use_average = False
    # save_path = './test_results_SVCT_2D_t940_path20_nonavg/'
    ...
    # save_path = './test_results_SVCT_2D_t940_path2_nonavg/'
