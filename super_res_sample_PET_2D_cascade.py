...
def main():
    ...
    args.num_cascade = 3
    save_path = './test_results_PET_2D_t200_path20_nonavg_cascade3/'
    ...
    # args.average_inv = None
    # args.num_cascade = 3
    # save_path = './test_results_PET_2D_t250_path20_nonavg_cascade3/'
    ...
    # args.average_inv = None
    # args.num_cascade = 3
    # save_path = './test_results_PET_2D_t300_path20_nonavg_cascade3/'
    ...
    # args.average_inv = None
    # args.num_cascade = 1
    # save_path = './test_results_PET_2D_t940_path20_nonavg_cascade1/'
...
def create_argparser():
    defaults = dict(
        ...
        use_ddim=True,
        base_samples="",
        model_path="./model_PET_2D/model300000.pt",
    )
