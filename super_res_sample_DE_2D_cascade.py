...
from dataloader_scripts.dataset_DE_2D import DE_Test
...
def main():
    ...
    # args.num_cascade = 3
    # save_path = './test_results_DE_2D_t200_path20_nonavg_cascade3/'
    ...
    # args.average_inv = None
    # args.num_cascade = 3
    # save_path = './test_results_DE_2D_t250_path20_nonavg_cascade3/'
    ...
    # args.average_inv = None
    # args.num_cascade = 3
    # save_path = './test_results_DE_2D_t300_path20_nonavg_cascade3/'
    ...
    # args.average_inv = None
    # args.num_cascade = 1
    # save_path = './test_results_DE_2D_t940_path20_nonavg_cascade1/'
    ...
    args.average_inv = None
    args.num_cascade = 1
    save_path = './test_results_DE_2D_t700_path6_nonavg_cascade1_random111/'
...
def create_argparser():
    defaults = dict(
        ...
        use_ddim=True,
        base_samples="",
        # model_path="./model_DE_2D/model300000.pt",
        model_path="./model_DE_2D/model280000.pt",
    )
